...
router.get('/', function(req, res, next) {
    if ('access_token' in req.cookies)
        res.render('index', { title: 'Deezer API', token: req.cookies.access_token});
    else
...
// GET '/api/deletetoken' 
router.get('/api/deletetoken', function (req, res, next) {
...
router.get('/api/call/userinfo', function (req, res, next) {
    var pathstr = "/user/me";
...
router.get('/api/call/history', function (req, res, next) {
